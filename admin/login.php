<?php
/**
 * SpaceShare — Admin Direct Login Page
 */
...
<head>
    ...
    <title>Admin Login — AVASTRA SpaceShare</title>
...
<body>
    <div class="login-card">
        <div class="text-center mb-4">
            <img src="<?= APP_URL; ?>/assets/images/logo/colored-logo.svg" alt="AVASTRA Logo" height="48" class="mb-3">
            <h4 class="fw-bold mb-1">Admin Portal Access</h4>
            <p class="text-muted small">Sign in with system administrator credentials</p>
        </div>
        ...
        <div class="mt-4 pt-3 border-top text-center text-muted extra-small" style="font-size:12px;">
